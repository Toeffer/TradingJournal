...
Latest scan day: **2026-08-07** · alert threshold: score ≥ 70 · regime: **supportive**

## Draft cards

### HAG.DE — scanner score 70 (EU-XETRA)

**Reason to research—not a proposal and not a trade.**

_Mechanical context:_
- date: 2026-08-07 | direction: long | source: scanner
- candidate_ref: scanner_signals.csv#2026-08-07:HAG.DE
- regime: supportive
- reference price: 94.8 (not an entry level)
- move 4.9834% | rel vol 3.5595x | 5d extension 4.1301%
- indicators, context only: RSI14 74.17 | EMA20 distance 14.26% | BB %B 1.062
