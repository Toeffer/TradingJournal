...
priced in, binary gap risk too high, unclear invalidation, weak source quality, or other
specific failure.
...
deep-dived; counts are honest (no padding). Rejected candidates are included. If nothing
qualifies this week, still create the file and say so.
